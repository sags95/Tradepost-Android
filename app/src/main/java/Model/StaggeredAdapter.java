...
public class StaggeredAdapter extends RecyclerView.Adapter<StaggeredAdapter.ViewHolder> {
    ...
    public StaggeredAdapter(List<MarketPlaceData> mData,View.OnClickListener mItemClick) {
        this.mData = mData;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.mTextViewProUsername.setText(mData.get(i).proUsername);
        if (i % 2 == 0) {
        ...
        viewHolder.mTextViewProUsername.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mTextViewProUsername;
        ...
        public ViewHolder(View itemView) {
            ...
            mTextViewProUsername = (TextView) itemView.findViewById(R.id.pro_username);
